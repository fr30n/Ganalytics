...
class GAnalyticsClientFactory
{
    public static function createForConfig(array $analyticsConfig): AnalyticsClient
    {
        ...
        return self::createGAnalyticsClient($analyticsConfig, $googleService);
    }
    ...
    protected static function createGAnalyticsClient(array $analyticsConfig, Google_Service_Analytics $googleService): AnalyticsClient
    {
